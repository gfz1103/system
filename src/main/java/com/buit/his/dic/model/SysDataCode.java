...
public class SysDataCode  extends  PageQuery{
	...
	//@ApiModelProperty(value="滚动方式,1:年,2:月,3:日,null:不滚动")
    /** 滚动方式,1:年,2:月,3:日 */
    private Integer datacodeScroll;
	...
	public Integer getDatacodeScroll() {
		return datacodeScroll;
	}
	public void setDatacodeScroll(Integer datacodeScroll) {
		this.datacodeScroll = datacodeScroll;
	}
}