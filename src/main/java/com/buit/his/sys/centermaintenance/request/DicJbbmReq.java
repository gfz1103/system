...
public class DicJbbmReq  extends PageQuery {
	private static final long serialVersionUID = 152085266318942458L;
	@ApiModelProperty(value="疾病序号", hidden = true)
    private Integer jbxh;
    @ApiModelProperty(value="代码类别 | 代码类别(9:ICD9,10:ICD10)", hidden = true)
    private Integer dmlb;
    @ApiModelProperty(value="疾病名称", hidden = true)
    private String jbmc;
    @ApiModelProperty(value="疾病类别", hidden = true)
    private Integer jblb;
    @ApiModelProperty(value="拼音码")
    private String pydm;
    @ApiModelProperty(value="排除 JBXH 集合")
    private List<Integer> notIn;
    @ApiModelProperty(value="ICD9 | ICD9，ICD码", hidden = true)
    private String icd9;
    @ApiModelProperty(value="ICD10 ", hidden = true)
    private String icd10;
    @ApiModelProperty(value="其它统计码 | 其它统计码，目前是病案统计码", hidden = true)
    private String qtxm;
    @ApiModelProperty(value="附加编码", hidden = true)
    private String fjbm;
    @ApiModelProperty(value="性别限制 | 性别限制(0.不限 1.限男 2.限女)", hidden = true)
    private Integer xbxz;
    @ApiModelProperty(value="允许治愈 | 允许治愈(0.禁止 1.允许)", hidden = true)
    private Integer yxzy;
    @ApiModelProperty(value="允许好转 | 允许好转(0.禁止 1.允许)", hidden = true)
    private Integer yxhz;
    @ApiModelProperty(value="允许未愈 | 允许未愈(0.禁止 1.允许)", hidden = true)
    private Integer yxwy;
    @ApiModelProperty(value="允许死亡 | 允许死亡(0.禁止 1.允许)", hidden = true)
    private Integer yxsw;
    @ApiModelProperty(value="允许其它 | 允许其它(0.禁止 1.允许)", hidden = true)
    private Integer yxqt;
    @ApiModelProperty(value="控制方式 | 控制方式(0.提醒 1.强制控制)，针对以上疾病规则", hidden = true)
    private Integer kzfs;
    @ApiModelProperty(value="疾病判别", hidden = true)
    private String jbpb;
    @ApiModelProperty(value="备注信息", hidden = true)
    private String bzxx;
    @ApiModelProperty(value="疾病报告卡", hidden = true)
    private String jbbgk;
    @ApiModelProperty(value="五笔码", hidden = true)
    private String wbdm;
    @ApiModelProperty(value="角形码", hidden = true)
    private String jxdm;
    @ApiModelProperty(value="其他码", hidden = true)
    private String qtdm;
    @ApiModelProperty(value="笔画码", hidden = true)
    private String bhdm;
    @ApiModelProperty(value="ybbmYh", hidden = true)
    private String ybbmYh;
    @ApiModelProperty(value="ybbm", hidden = true)
    private String ybbm;
    @ApiModelProperty(value="mzsy", hidden = true)
    private String mzsy;
    @ApiModelProperty(value="jbdl", hidden = true)
    private Integer jbdl;
    @ApiModelProperty(value="jblx", hidden = true)
    private Integer jblx;
    @ApiModelProperty(value="zfbz", hidden = true)
    private Integer zfbz;
    @ApiModelProperty(value="lbdm", hidden = true)
    private String lbdm;
    @ApiModelProperty(value="icdbf", hidden = true)
