...
public class DicZlxmReq{
    ...
    private List<DiccZlsfdzReq> diccZlsfdzReqList;
    /**
     * 设置:诊疗项目 ID
     */
    ...
    public List<DiccZlsfdzReq> getDiccZlsfdzReqList() {
        return diccZlsfdzReqList;
    }

    public void setDiccZlsfdzReqList(List<DiccZlsfdzReq> diccZlsfdzReqList) {
        this.diccZlsfdzReqList = diccZlsfdzReqList;
    }
}
