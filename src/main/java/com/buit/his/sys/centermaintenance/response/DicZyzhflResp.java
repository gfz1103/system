...
/**
 * 类名称：DicZyzhflResp<br>
 * 类描述：中医证候分类<br>
 *
 * @author liushijie
 */
@ApiModel(value = "中医证候分类")
public class DicZyzhflResp {
    ...
    private List<DicZyzhflResp> childrenList;
    ...
    public List<DicZyzhflResp> getChildrenList() {
        return childrenList;
    }

    public void setChildrenList(List<DicZyzhflResp> childrenList) {
