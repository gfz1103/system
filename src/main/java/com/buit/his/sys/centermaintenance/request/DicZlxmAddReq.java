...
public class DicZlxmAddReq {
    ...
    private List<DiccZlsfdzAddReq> diccZlsfdzAddReqList;
    /**
     * 设置:项目名称
     */
    ...
    public List<DiccZlsfdzAddReq> getDiccZlsfdzAddReqList() {
        return diccZlsfdzAddReqList;
    }

    public void setDiccZlsfdzAddReqList(List<DiccZlsfdzAddReq> diccZlsfdzAddReqList) {
        this.diccZlsfdzAddReqList = diccZlsfdzAddReqList;
    }
}
