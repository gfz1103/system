 ...
 * @author GONGFANGZHOU
 */
@ApiModel(value="设备编号表_Resp")
public class OpSbbhResp  extends  PageQuery{
	private static final long serialVersionUID = 1970536367855702768L;
    ...
    private String sbmc;
    @ApiModelProperty(value="接口类型(字典:sys_flag_data:JK000001)")
    private String jklx;
    ...
    private String sbdz;
    @ApiModelProperty(value="门诊使用(1:是,0:否)")
    private String mzsy;
    @ApiModelProperty(value="住院使用(1:是,0:否)")
    private String zysy;
    @ApiModelProperty(value="体检使用(1:是,0:否)")
    private String tjsy;
    /**
     * 设置:编号ID
     */
