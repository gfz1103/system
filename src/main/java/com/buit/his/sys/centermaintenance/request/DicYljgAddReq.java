...
public class DicYljgAddReq {
    ...
    @NotNull(message = "医疗机构代码(医保)")
    @Size(max = 20)
    @ApiModelProperty(value = "医疗机构代码(医保)", required = true)
    private String hospitalCode;
    @NotNull(message = "上级医疗机构ID不能为空")
    @ApiModelProperty(value = "上级医疗机构ID", required = true)
    private Integer parentHospitalId;
    @NotNull(message = "医疗机构组织机构代码不能为空")
    @Size(max = 20)
    @ApiModelProperty(value = "医疗机构组织机构代码DE08.10.052.00")
    private String organizationCode;
    @NotNull(message = "医疗机构名称不能为空")
    @Size(max = 25)
    @ApiModelProperty(value = "医疗机构名称 DE08.10.013.00", required = true)
    private String hospitalName;
    @Size(max = 25)
    @ApiModelProperty(value = "第二医疗机构名称")
    private String secondHospitalName;
    @NotNull(message = "医院医保全称不能为空")
    @Size(max = 25)
    @ApiModelProperty(value = "医院医保全称", required = true)
